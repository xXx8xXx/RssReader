...
public class RSSHandler extends DefaultHandler {
	...
	private FeedItem currentArticle = new FeedItem();
	private List<FeedItem> articleList = new ArrayList<FeedItem>();
	...
	public void startElement(String uri, String localName, String qName, Attributes atts) {
		if (localName.equalsIgnoreCase("enclosure")){
			Log.d("LOGGING RSS XML", "Setting article enclosure: " + atts.getValue("url"));
			currentArticle.setEnclosure(atts.getValue("url"));
		}
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		else if (localName.equalsIgnoreCase("link"))
		{
			...
			//currentArticle.setLink(new URL(chars.toString()));
	...
	public List<FeedItem> getLatestArticles(String feedUrl) {
		...
		try {
			...
			try {
				...
				Log.e("RSS HANDLER getLatestArticles", e.getMessage() + " >> " + e.toString());
			}
